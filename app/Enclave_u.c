...
sgx_status_t create_sealeddata_for_serializable(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* sealed_log, uint32_t sealed_log_size)
{
	sgx_status_t status;
	ms_create_sealeddata_for_serializable_t ms;
...
sgx_status_t verify_sealeddata_for_serializable(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* sealed_log, uint32_t sealed_log_size)
{
	sgx_status_t status;
	ms_verify_sealeddata_for_serializable_t ms;
	ms.ms_sealed_log = sealed_log;
	ms.ms_sealed_log_size = sealed_log_size;
